...
3. **Deep analytics** ✅ — estimated-1RM progression + muscle split on Progress, dashboard streak, and **training-readiness inference** (acute:chronic workload ratio surfaced on the dashboard) — all from the canonical `metrics` module.
